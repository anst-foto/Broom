...
* Сохраняет информацию об удалённых файлах в `C:\users\$env:USERNAME\broom.log`
...
* Скомпилированный EXE-файл (компиляцция в **PS2EXE-GUI v0.5.0.6 by Ingo Karstein, reworked and GUI support by Markus Scholtes**)
* Компиляция EXE-файла *PS2EXE-GUI* уменьшило запуск программы в несколько раз, по сравнению с запуском EXE-файла скомпилированного *PowerGUI Script Editor v3.8.0.129*
